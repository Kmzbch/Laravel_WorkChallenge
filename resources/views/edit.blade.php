        ...
        <div class="col-8 justify-content-center div-style content">
            ...
            <form action="/labs/{{$lab->id}}/update" method="POST">
                ...
                <div class="form-group">
                    <label for="name">Name</label> <input type="text" class="form-control" id="name" name="name" placeholder="Enter a lab name" value="{{$lab->name}}" required /></span>
                </div>
                <div class="form-group">
                    <label for="location">Location</label> <input type="text" class="form-control" id="location" name="location" placeholder="Enter a location" value="{{$lab->location}}" required /></span>
                </div>
                <div id="map">
